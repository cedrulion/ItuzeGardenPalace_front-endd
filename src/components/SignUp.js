        ...
        <form onSubmit={handleSignup} className="text-center ">
          ...
          <div>
              <input
                ...
                className={`input-field font-bold bg-transparent text-white border-b-2 border-white ${errors.firstname && 'border-red-500'}`}
                required
              />
            ...
            <div>
              <input
                ...
                onChange={handleInputChange}
                className={`input-field font-bold bg-transparent text-white border-b-2 border-white ${errors.lastname && 'border-red-500'}`}
                required
              />
            ...
            <div>
              <input
                ...
                onChange={handleInputChange}
                className={`input-field font-bold bg-transparent text-white border-b-2 border-white ${errors.phonenumber && 'border-red-500'}`}
                required
              />
